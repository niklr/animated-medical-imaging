...
namespace AMI.Core.Entities.Models
{
    ...
    public class AxisContainerModel<T>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AxisContainerModel{T}"/> class.
        /// </summary>
        /// <param name="axisType">Type of the axis.</param>
        /// <param name="entity">The entity to associate with the axis.</param>
        public AxisContainerModel(AxisType axisType, T entity)
        {
            AxisType = axisType;
            Entity = entity;
        }
