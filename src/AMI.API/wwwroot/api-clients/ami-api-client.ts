...
export interface IEventsAmiApiClient {
    /**
     * Get paginated list of events
     * @param page (optional) The current page.
     * @param limit (optional) The limit to constrain the number of items.
     * @return A model containing a list of paginated events.
     */
    getPaginated(page: number | undefined, limit: number | undefined): Observable<PaginationResultModelOfEventModel>;
}

@Injectable()
export class EventsAmiApiClient implements IEventsAmiApiClient {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<PaginationResultModelOfEventModel>><any>_observableThrow(e);
                }
            } else
                return <Observable<PaginationResultModelOfEventModel>><any>_observableThrow(response_);
        }));
    }

    protected processGetPaginated(response: HttpResponseBase): Observable<PaginationResultModelOfEventModel> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 400) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = PaginationResultModelOfEventModel.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<PaginationResultModelOfEventModel>(<any>null);
    }
}
...
export interface IWebhooksAmiApiClient {
    /**
     * Get webhook by id
     * @param id The identifier of the webhook.
     * @return A model containing the specified webhook.
     */
     ...
     * @return No content.
     */
    deleteById(id: string | null): Observable<WebhookModel>;
    /**
     * Get paginated list of webhooks
     * @param page (optional) The current page.
     * @param limit (optional) The limit to constrain the number of items.
     * @return A model containing a list of paginated webhooks.
     */
    getPaginated(page: number | undefined, limit: number | undefined): Observable<PaginationResultModelOfWebhookModel>;
    /**
     * Create webhook
     * @param command The command to create a new webhook.
     * @return A model containing the created webhook.
     */
    create(command: CreateWebhookCommand): Observable<WebhookModel>;
}

@Injectable()
export class WebhooksAmiApiClient implements IWebhooksAmiApiClient {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    protected processDeleteById(response: HttpResponseBase): Observable<WebhookModel> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 400) {
            ...
            let result204: any = null;
            let resultData204 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result204 = WebhookModel.fromJS(resultData204);
            return _observableOf(result204);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
     ...
     */
    getPaginated(page: number | undefined, limit: number | undefined): Observable<PaginationResultModelOfWebhookModel> {
        let url_ = this.baseUrl + "/webhooks?";
        if (page === null)
            throw new Error("The parameter 'page' cannot be null.");
        else if (page !== undefined)
            url_ += "page=" + encodeURIComponent("" + page) + "&"; 
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<PaginationResultModelOfWebhookModel>><any>_observableThrow(e);
                }
            } else
                return <Observable<PaginationResultModelOfWebhookModel>><any>_observableThrow(response_);
        }));
    }

    protected processGetPaginated(response: HttpResponseBase): Observable<PaginationResultModelOfWebhookModel> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 400) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = PaginationResultModelOfWebhookModel.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<PaginationResultModelOfWebhookModel>(<any>null);
    }
    ...
    protected processCreate(response: HttpResponseBase): Observable<WebhookModel> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 400) {
            ...
            let result201: any = null;
            let resultData201 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result201 = WebhookModel.fromJS(resultData201);
            return _observableOf(result201);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
...
export class PaginationResultModelOfEventModel implements IPaginationResultModelOfEventModel {
    items?: EventModel[] | undefined;
    pagination?: PaginationModel | undefined;

    constructor(data?: IPaginationResultModelOfEventModel) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            if (Array.isArray(data["items"])) {
                this.items = [] as any;
                for (let item of data["items"])
                    this.items!.push(EventModel.fromJS(item));
            }
            this.pagination = data["pagination"] ? PaginationModel.fromJS(data["pagination"]) : <any>undefined;
        }
    }

    static fromJS(data: any): PaginationResultModelOfEventModel {
        data = typeof data === 'object' ? data : {};
        let result = new PaginationResultModelOfEventModel();
        result.init(data);
        return result;
    }
...
export interface IPaginationResultModelOfEventModel {
    items?: EventModel[] | undefined;
    pagination?: PaginationModel | undefined;
}

/** A model containing information about an event that occurred. An event is created for example when the status of a task changes. */
...
Provided only if the deserialization failed. */
    dataSerialized?: string | undefined;
    /** Gets or sets the data associated with the event. */
    data?: BaseEventDataModel | undefined;
    ...
    init(data?: any) {
        if (data) {
            ...
            this.dataSerialized = data["dataSerialized"];
            this.data = data["data"] ? BaseEventDataModel.fromJS(data["data"]) : <any>undefined;
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["dataSerialized"] = this.dataSerialized;
...
export abstract class BaseEventDataModel implements IBaseEventDataModel {

    protected _discriminator: string;

    constructor(data?: IBaseEventDataModel) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        this._discriminator = "BaseEventDataModel";
    }

    init(data?: any) {
    }

    static fromJS(data: any): BaseEventDataModel {
        data = typeof data === 'object' ? data : {};
        if (data["discriminator"] === "TaskEventDataModel") {
            let result = new TaskEventDataModel();
            result.init(data);
            return result;
        }
        if (data["discriminator"] === "ObjectEventDataModel") {
            let result = new ObjectEventDataModel();
            result.init(data);
            return result;
        }
        if (data["discriminator"] === "AuditEventDataModel") {
            let result = new AuditEventDataModel();
            result.init(data);
            return result;
        }
        if (data["discriminator"] === "WorkerEventDataModel") {
            let result = new WorkerEventDataModel();
            result.init(data);
            return result;
        }
        throw new Error("The abstract class 'BaseEventDataModel' cannot be instantiated.");
    }
...
/** The base properties all event data have in common. */
export interface IBaseEventDataModel {
}

/** A model containing information about the event. */
export class TaskEventDataModel extends BaseEventDataModel implements ITaskEventDataModel {
    /** Gets or sets the object. */
    object?: TaskModel | undefined;

    constructor(data?: ITaskEventDataModel) {
        super(data);
        this._discriminator = "TaskEventDataModel";
    }

    init(data?: any) {
        super.init(data);
        if (data) {
            this.object = data["object"] ? TaskModel.fromJS(data["object"]) : <any>undefined;
        }
    }

    static fromJS(data: any): TaskEventDataModel {
        data = typeof data === 'object' ? data : {};
        let result = new TaskEventDataModel();
        result.init(data);
        return result;
...
/** A model containing information about the event. */
export interface ITaskEventDataModel extends IBaseEventDataModel {
    /** Gets or sets the object. */
    object?: TaskModel | undefined;
}
...
/** A model containing information about the event. */
export class ObjectEventDataModel extends BaseEventDataModel implements IObjectEventDataModel {
    /** Gets or sets the object. */
    object?: ObjectModel | undefined;

    constructor(data?: IObjectEventDataModel) {
        super(data);
        this._discriminator = "ObjectEventDataModel";
    }
    ...
    static fromJS(data: any): ObjectEventDataModel {
        data = typeof data === 'object' ? data : {};
        let result = new ObjectEventDataModel();
        result.init(data);
        return result;
...
/** A model containing information about the event. */
export interface IObjectEventDataModel extends IBaseEventDataModel {
    /** Gets or sets the object. */
    object?: ObjectModel | undefined;
}

/** A model containing information about the event. */
export class AuditEventDataModel extends BaseEventDataModel implements IAuditEventDataModel {
    /** Gets or sets the object. */
    object?: AuditEventModel | undefined;

    constructor(data?: IAuditEventDataModel) {
        super(data);
        this._discriminator = "AuditEventDataModel";
    }

    init(data?: any) {
        super.init(data);
        if (data) {
            this.object = data["object"] ? AuditEventModel.fromJS(data["object"]) : <any>undefined;
        }
    }

    static fromJS(data: any): AuditEventDataModel {
        data = typeof data === 'object' ? data : {};
        let result = new AuditEventDataModel();
        result.init(data);
        return result;
...
/** A model containing information about the event. */
export interface IAuditEventDataModel extends IBaseEventDataModel {
    /** Gets or sets the object. */
    object?: AuditEventModel | undefined;
}

/** A model containing information about the event. */
export class WorkerEventDataModel extends BaseEventDataModel implements IWorkerEventDataModel {
    /** Gets or sets the object. */
    object?: BaseWorkerModel | undefined;

    constructor(data?: IWorkerEventDataModel) {
        super(data);
        this._discriminator = "WorkerEventDataModel";
    }

    init(data?: any) {
        super.init(data);
        if (data) {
            this.object = data["object"] ? BaseWorkerModel.fromJS(data["object"]) : <any>undefined;
        }
    }

    static fromJS(data: any): WorkerEventDataModel {
        data = typeof data === 'object' ? data : {};
        let result = new WorkerEventDataModel();
        result.init(data);
        return result;
...
/** A model containing information about the event. */
export interface IWorkerEventDataModel extends IBaseEventDataModel {
    /** Gets or sets the object. */
    object?: BaseWorkerModel | undefined;
}
...
Specify ['*'] to enable all events. */
    ...
    constructor(data?: IWebhookModel) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            this.url = data["url"];
            this.apiVersion = data["apiVersion"];
            if (Array.isArray(data["enabledEvents"])) {
                this.enabledEvents = [] as any;
                for (let item of data["enabledEvents"])
                    this.enabledEvents!.push(item);
            }
            this.userId = data["userId"];
        }
    }

    static fromJS(data: any): WebhookModel {
        data = typeof data === 'object' ? data : {};
        let result = new WebhookModel();
        result.init(data);
        return result;
    }
...
export class PaginationResultModelOfWebhookModel implements IPaginationResultModelOfWebhookModel {
    items?: WebhookModel[] | undefined;
    pagination?: PaginationModel | undefined;

    constructor(data?: IPaginationResultModelOfWebhookModel) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            if (Array.isArray(data["items"])) {
                this.items = [] as any;
                for (let item of data["items"])
                    this.items!.push(WebhookModel.fromJS(item));
            }
            this.pagination = data["pagination"] ? PaginationModel.fromJS(data["pagination"]) : <any>undefined;
        }
    }

    static fromJS(data: any): PaginationResultModelOfWebhookModel {
        data = typeof data === 'object' ? data : {};
        let result = new PaginationResultModelOfWebhookModel();
        result.init(data);
        return result;
    }
...
export interface IPaginationResultModelOfWebhookModel {
    items?: WebhookModel[] | undefined;
    pagination?: PaginationModel | undefined;
}

export abstract class BaseWebhookCommandOfWebhookModel implements IBaseWebhookCommandOfWebhookModel {
    url?: string | undefined;
    apiVersion?: string | undefined;
    secret?: string | undefined;
    enabledEvents?: string[] | undefined;

    constructor(data?: IBaseWebhookCommandOfWebhookModel) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): BaseWebhookCommandOfWebhookModel {
        data = typeof data === 'object' ? data : {};
        throw new Error("The abstract class 'BaseWebhookCommandOfWebhookModel' cannot be instantiated.");
    }
...
export interface IBaseWebhookCommandOfWebhookModel {
    url?: string | undefined;
    apiVersion?: string | undefined;
    secret?: string | undefined;
    enabledEvents?: string[] | undefined;
...
export class CreateWebhookCommand extends BaseWebhookCommandOfWebhookModel implements ICreateWebhookCommand {

    constructor(data?: ICreateWebhookCommand) {
        super(data);
    }
    ...
    static fromJS(data: any): CreateWebhookCommand {
        data = typeof data === 'object' ? data : {};
        let result = new CreateWebhookCommand();
        result.init(data);
        return result;
    }
