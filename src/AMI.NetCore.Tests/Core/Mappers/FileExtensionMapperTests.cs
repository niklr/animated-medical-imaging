...
namespace AMI.NetCore.Tests.Core.Mappers
{
    ...
    {
        [TestCase("", ".dcm", FileExtensionType.Default, FileFormat.Dicom, false)]
        ...
        [TestCase("C:\temp\test.tar", ".tar", FileExtensionType.Default, FileFormat.Tar, true)]
        ...
        [TestCase("test.test", ".dcm", FileExtensionType.Default, FileFormat.Dicom, false)]
        [TestCase("test.dcm", ".dcm", FileExtensionType.Default, FileFormat.Dicom, false)]
        [TestCase("test.hdr", ".img", FileExtensionType.Source, FileFormat.Analyze, false)]
        [TestCase("test.img", ".hdr", FileExtensionType.Header, FileFormat.Analyze, false)]
        [TestCase("test.mhd", ".raw", FileExtensionType.Source, FileFormat.MetaImage, false)]
        [TestCase("test.raw", ".mhd", FileExtensionType.Header, FileFormat.MetaImage, false)]
        [TestCase("test.nii", ".nii", FileExtensionType.Default, FileFormat.Nifti, false)]
        [TestCase("test.nii.gz", ".gz", FileExtensionType.Default, FileFormat.GZip, true)]
        [TestCase("test.tar.gz", ".gz", FileExtensionType.Default, FileFormat.GZip, true)]
        [TestCase("C:\temp\test.tar", ".tar", FileExtensionType.Default, FileFormat.Tar, true)]
